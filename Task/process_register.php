<?php
	...
	if(!empty($_POST))
	{
		...
		if(empty($_POST['fnm']) || empty($_POST['unm']) || empty($_POST['gender']) || empty($_POST['pwd']) || empty($_POST['cpwd']) ||empty($_POST['Type']) || empty($_POST['mail'])||empty($_POST['city']))
		{
		...
		else
		{
			...
			$query="insert into user(u_fnm,u_unm,u_pwd,Type,u_gender,u_email,u_contact,u_city)
			values('$fnm','$unm','$pwd','$type1','$gender','$email','$contact','$city')";
