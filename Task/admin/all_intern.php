		...
		<div class="post">
			...
			<div class="entry">
					...
					<table border='1' WIDTH='100%'>
						<tr>
						<td colspan="7"><a href="addintern.php">Add New Intern</a></td>
						</tr>
						<tr>
							...
							<TD style="color:darkgreen" WIDTH='25%'><b><u>STIPAND</u></b></TD>
						...
						<?php
							...
							echo '<tr>
									...
									echo 	'<td><a href="process_del_intern.php?sid='.$row['b_id'].'"><img src="images/drop.png" ></a>
