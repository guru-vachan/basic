...
// session_start();
	...
	{
		header("location:internlist.php?subcatid=".$row1['subcat_id']."&subcatnm=".$row1["subcat_nm"]);
							...
							<div class="entry">
								...
								<?php
									Do
									{
										...
										echo '<li><a href="internlist.php?subcatid='.$row1['subcat_id'].'&subcatnm='.$row1["subcat_nm"].'">'.$row1['subcat_nm'].'</a></li>';
