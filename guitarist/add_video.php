...
<div class="sign_up">
			<!----------start form----------->
			<form class="sign" action="add_vid_process.php" method="post" enctype="multipart/form-data">
				...
				<div class="bottom-section">
					...
					<div class="input-sign email">
							Upload Video :<input id="file" type="file" name="data_file"   />
						</div>
					<div class="submit">
...
$sql = mysql_query("select * from videos where user_id='$name'");
while ($row = mysql_fetch_assoc($sql))
{
