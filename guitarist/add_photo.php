...
<div class="sign_up">
			<!----------start form----------->
			<form class="sign" action="add_photo_process.php" method="post" enctype="multipart/form-data">
				<div class="formtitle">Add Photos.</div>
				<!----------start top_section----------->
...
$sql = mysql_query("select * from photos where user_id='$name'");
while ($row = mysql_fetch_assoc($sql))
{
